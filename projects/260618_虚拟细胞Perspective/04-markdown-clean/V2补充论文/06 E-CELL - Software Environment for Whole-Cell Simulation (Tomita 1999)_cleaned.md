...
**Figure 3.** Ontology structure of the E-CELL system. There are three fundamental classes: Substance, Reactor and System. Reactors and CellComponents are the user-definable classes. See our web site for more detailed information.

**Figure 4.** The transcription metabolism in the model cell.

**Figure 5.** The quantity of ATP increases temporarily and then decreases rapidly when glucose in the culture medium is completely drained at 20 s. The y-axis is the number of ATP molecules (×1000) in the cytoplasm and the x-axis is the elapsed time in seconds.

**Figure 6.** A trace of mRNA levels before and after starvation of the cell. Before starvation at 1000 s, synthesis by transcription and spontaneous degradation are close to equilibrium. The loss of ATP following starvation causes transcription to stop, and mRNA levels decrease rapidly.